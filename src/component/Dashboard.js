...
let sideBarStyle = "navbar-nav bg-gradient-primary sidebar sidebar-dark accordion";
let sideBarStyleSecond = "navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled";

function Dashboard()
{
    const [toggle, setToggle] = useState(sideBarStyle);
    const changeSidebar=()=>{
        if(toggle == sideBarStyle){
            setToggle(sideBarStyleSecond)
        }
        else{
            setToggle(sideBarStyle)
        }
    }
    return (
        <>
  ...
  <div id="wrapper">
    ...
    >
      ...
      <div className="text-center d-none d-md-inline">
        <button className="rounded-circle border-0" id="sidebarToggle" onClick={changeSidebar} />
      </div>
      {/* Sidebar Message */}
